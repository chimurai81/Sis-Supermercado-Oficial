...
namespace Clientes.Formularios
{
    public partial class FrmEditarRegistroClientes : Form
    {
        ...
        public void EditarClientes(string id)
        {
            ...
            sql = "update alumnosfutsal set Nombre=@Nombre, Apellido=@Apellido, CiNro=@CiNro, Ruc=@Ruc, NroTelef=@NroTelef, " +
                  "FechaNac=@FechaNac, Direccion=@Direccion, where id_Clientes=@id_Clientes";
            MySqlCommand comando;
            try
            {
